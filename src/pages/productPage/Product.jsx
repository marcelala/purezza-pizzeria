...
export default function Product({ product }) {
  const { name, fullDescription, img, ingredientList, nutritionalInfo } =
    product; // if you rename to ingredients and nutritionInfo it would fit in 1 line.
  const imageSrc = require(`../../assets/img/foods/${img}`).default; // don't use abreviations
